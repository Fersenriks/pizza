    ...
    <div className={classes.cart__item}>
      ...
      <div className={classes.cart__item_tools}>
        <div className={classes.cart__item_count}>
          <div
            className={`${classes.button} ${classes.button__outline} ${classes.button__circle} ${classes.cart__item_count_minus}`}
          >
            <svg
              width='10'
              height='10'
        ...
        <div className={classes.cart__item_remove}>
          <div className={`${classes.button} ${classes.button__outline} ${classes.button__circle}`}>
            <svg
              width='10'
              height='10'
              viewBox='0 0 10 10'
